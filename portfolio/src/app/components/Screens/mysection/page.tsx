    ...
    return (
      <section id="home" className="flex flex-col items-center text-center py-16 ">
          ...
          <motion.p
              ...
              user-friendly and efficient digital solutions. Welcome to my portfolio, where innovation meets technology.
          </motion.p>
          ...
          <div className="flex space-x-4">
              ...
              >
                  <a
                      href="/CV/Lakshan_Shalintha.pdf"
                      download="Lakshan_Shalintha.pdf"
                  >
                      My Resume ↗
                  </a>
              </motion.button>
