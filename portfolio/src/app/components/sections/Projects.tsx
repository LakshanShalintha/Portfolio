        ...
        <div className="flex flex-col items-center mt-32">
          ...
          >
            {filteredProjects.map((project) => (
                <motion.div
                    key={project.id}
                    className="relative w-[500px] max-w-xs h-[350px]  rounded-[19px] flex flex-col border-2 transition-transform duration-300 hover:shadow-black dark:border-white dark:hover:shadow-white dark:hover:bg-darkHover/50"
                  ...
                  <div className="h-1/3 flex flex-col justify-between p-4">
                    ...
                    <div className="flex mb-2 gap-1">
                      {project.smallGridTexts.map((text, smallIndex) => (
                          <div
                              key={smallIndex}
                              className="w-[70px] h-[25px] bg-gray-500 rounded-md flex items-center justify-center  text-xs -mb-2"
                          >
                            {text}
                          </div>
                      ))}
                    ...
                    <div className="flex space-x-2">
                      <a href={project.gitUrl} target="_blank" rel="noopener noreferrer">
                        <button
                            className="w-[70px] h-[25px] rounded border-2 hover:bg-purple-800 transition-colors text-xs"
                        >
                          View Project
                        </button>
                      </a>
                      {project.hasDemo && ( // Conditionally render the button
                          <a href={project.demoUrl} target="_blank" rel="noopener noreferrer">
                            <button
                                className="border-2 w-[70px] h-[25px] rounded hover:bg-purple-800 transition-colors text-xs"
                            >
                              View Demo
                            </button>
                          </a>
